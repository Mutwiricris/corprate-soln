...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <div wire:loading class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            ...
            <span class="ml-3 text-white font-medium">Loading...</span>
        </div>
        <flux:sidebar sticky stashable class="border-e border-indigo-200 bg-zinc-50 dark:border-zinc-700
        dark:bg-zinc-900">
            <flux:sidebar.toggle class="lg:hidden" icon="x-mark" />

            <a href="{{ route('dashboard') }}" class="me-5  font-bold text-lg flex items-center space-x-2
            rtl:space-x-reverse"
               wire:navigate>
                <span class="bg-teal-800 p-1 font-extrabold rounded-md mr-2 px-3 text-center  text-white"> A</span>
                Ascend
            </a>
...
{{--                //finance section--}}
                <flux:navlist.group :heading="__('Finances')" class="grid ">
{{--                    <flux:navlist.item  :href="route('dashboard')" :current="request()->routeIs('')"--}}
{{--                                       wire:navigate></flux:navlist.item>--}}
{{--                    <flux:navlist.item icon="chart-bar" :href="route('analytics')" :current="request()->routeIs--}}
{{--                    ('analytics')" wire:navigate>{{ __('Analytics') }}</flux:navlist.item>--}}
